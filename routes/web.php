...
Route::get("registros/{registro}/picture", [
...
Route::patch("registros/{registro}/invalidate", [
    RegistroController::class,
    "invalidate",
]);
...
Route::post("ocorrencias/{ocorrencia}/solved", [
    OcorrenciaController::class,
    "solved",
]);
...
Route::get("ocorrencias/{ocorrencia}/edit", [
    OcorrenciaController::class,
    "edit",
]);
Route::patch("ocorrencias/{ocorrencia}/", [
    OcorrenciaController::class,
    "update",
]);
Route::delete("ocorrencias/{ocorrencia}", [
    OcorrenciaController::class,
    "destroy",
]);

Route::get("pessoas", [PessoaController::class, "index"]);
Route::get("pessoas/pro-aluno", [PessoaController::class, "listarMonitoresProAluno"]);
